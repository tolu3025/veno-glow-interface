...
const MainLayout = () => {
  ...
  const hasContent = !['/maintenance', '/404'].includes(location.pathname);
    ...
    <AdProvider>
      <div className="min-h-screen flex flex-col">
        <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur">
          ...
          {/* Header ad - only show when page has content */}
          {hasContent && (
            <div className="container py-2">
              <AdPlacement location="header" contentAvailable={hasContent} />
            </div>
          )}
        </header>
        ...
        <footer className="border-t py-4">
          ...
          {/* Footer ad - only show when page has content */}
          {hasContent && (
            <div className="container mt-4">
              <AdPlacement location="footer" contentAvailable={hasContent} />
            </div>
          )}
        </footer>
      </div>
