  ...
  return <div className="flex min-h-screen">
      ...
      <div className="w-64 bg-slate-900 text-white p-5">
        ...
        <nav className="space-y-2">
          ...
          <NavLink to="/admin/questions" className={({
          isActive
        }) => `flex items-center p-2 rounded-lg ${isActive ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800'}`}>
          ...
          <NavLink to="/admin/blog" className={({
          isActive
        }) => `flex items-center p-2 rounded-lg ${isActive ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800'}`}>
          ...
          <NavLink to="/admin/assign-admin" className={({
          isActive
        }) => `flex items-center p-2 rounded-lg ${isActive ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800'}`}>
        ...
        <div className="mt-auto pt-5 border-t border-slate-800 mt-8">
          <Button variant="outline" onClick={() => window.location.href = '/'} className="w-full text-zinc-950">
            Back to Site
          </Button>
        </div>
      </div>
